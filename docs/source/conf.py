...
# -*- coding: utf-8 -*-
#
# data_structure_visualizer documentation build configuration file
#
...
project = 'data_structure_visualizer'
copyright = '2021, José Romero'
author = 'José Romero'
...
_version_py = os.path.join(repo, 'data_structure_visualizer', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'data_structure_visualizerdoc'
...
latex_documents = [
    (master_doc, 'data_structure_visualizer.tex', 'data_structure_visualizer Documentation',
     'José Romero', 'manual'),
]
...
man_pages = [
    ...
    'data_structure_visualizer Documentation',
     [author], 1)
]
